...
export default function Home() {
  ...
  const [item, setItem] = useState({
    name: 'Tsedaka token',
    description: 'carte 5 euros',
    image:
      'https://images.unsplash.com/photo-1534951009808-766178b47a4f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=80',
    quantity: 1,
    price: 5,
  });
